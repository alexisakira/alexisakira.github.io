...
1. Regarding the timing, if possible, it is best to do a Roth conversion during a market downturn, because that way you generate less income for the same number of shares converted.
...
1. During the same year, convert a traditional IRA to Roth.
...
1. However, if you gift stocks, the recipient inherits the cost basis of the donor, so there will still be capital gains if the investment is sold. Currently, a child's unearned income (e.g., capital gains) of more than $2,700 is taxed at the parents' rate (see [here](https://www.fidelity.com/learning-center/personal-finance/kiddie-tax)).
1. Therefore, as long as you donate stocks with capital gains up to $2,700 and assuming the child has low income, there will be no or low capital gains tax. (To be precise, the first $1,350 has no tax and the remaining $1,350 is taxed at 10%.) Thus, if you trust your kids, you can donate appreciated stocks with capital gains up to this limit, let them sell the investment, and then ask them to pay the bills.
1. You can donate appreciated stocks to your minor children by using UTMA accounts.